...
public class FontManager {
    ...
    private static final String TYPE1_FONT_DIFFS[][] =
            {{"Bookman-Demi", "URWBookmanL-DemiBold", "Arial"},
                    ...
                    {"Courier", "Nimbus Mono L Regular", "NimbusMonL-Regu", "CourierNew", "CourierNewPSMT"},
                    {"Courier-Oblique", "Nimbus Mono L Regular Oblique", "NimbusMonL-ReguObli", "Courier,Italic", "CourierNew-Italic", "CourierNew,Italic", "CourierNewPS-ItalicMT"},
                    {"Courier-Bold", "Nimbus Mono L Bold", "NimbusMonL-Bold", "Courier,Bold", "CourierNew,Bold", "CourierNew-Bold", "CourierNewPS-BoldMT"},
                    {"Courier-BoldOblique", "Nimbus Mono L Bold Oblique", "NimbusMonL-BoldObli", "Courier,BoldItalic", "CourierNew-BoldItalic", "CourierNew,BoldItalic", "CourierNewPS-BoldItalicMT"},
                    ...
                    {"Helvetica", "Helvetica", "Nimbus Sans L Regular", "Arial", "ArialMT", "NimbusSanL-Regu", "Nimbus Sans L"},
//             {"Helvetica", "NimbusSanL-Regu", "Nimbus Sans L", "Arial", "ArialMT"},  // known problem in Phelps nfont engine
                    {"Helvetica-Oblique", "Nimbus Sans L Regular Italic", "NimbusSanL-ReguItal", "Helvetica,Italic", "Helvetica-Italic", "Arial,Italic", "Arial-Italic", "Arial-ItalicMT, "},
//             {"Helvetica-Bold", "NimbusSanL-Bold", "Nimbus Sans L", "Helvetica-Black", "Helvetica,Bold", "Arial,Bold", "Arial-Bold", "Arial-BoldMT"},  // known problem in Phelps nfont engine
                    {"Helvetica-Bold", "Helvetica,Bold", "Arial,Bold", "Arial-Bold", "Arial-BoldMT", "Nimbus Sans L Bold","NimbusSanL-Bold", "Nimbus Sans L"},
                    {"Helvetica-BoldOblique", "Nimbus Sans L Regular Italic", "NimbusSanL-BoldItal", "Helvetica-BlackOblique", "Helvetica,BoldItalic", "Helvetica-BoldItalic", "Arial,BoldItalic", "Arial-BoldItalic", "Arial-BoldItalicMT"},
                    ...
                    {"Times-Roman", "Nimbus Roman No9 L Regular", "NimbusRomNo9L-Regu", "TimesNewRoman", "TimesNewRomanPSMT", "TimesNewRomanPS"},
                    {"Times-Italic", "Nimbus Roman No9 L Regular Italic", "NimbusRomNo9L-ReguItal", "TimesNewRoman,Italic", "TimesNewRoman-Italic", "TimesNewRomanPS-Italic", "TimesNewRomanPS-ItalicMT"},
                    {"Times-Bold", "Nimbus Roman No9 L Medium", "NimbusRomNo9L-Medi", "TimesNewRoman,Bold", "TimesNewRoman-Bold", "TimesNewRomanPS-Bold", "TimesNewRomanPS-BoldMT"},
                    {"Times-BoldItalic", "Nimbus Roman No9 L Medium Italic", "NimbusRomNo9L-MediItal", "TimesNewRoman,BoldItalic", "TimesNewRoman-BoldItalic", "TimesNewRomanPS-BoldItalic", "TimesNewRomanPS-BoldItalicMT"},
