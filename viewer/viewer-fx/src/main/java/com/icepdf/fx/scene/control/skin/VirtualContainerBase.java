 ...
 * @profile common
 */
public abstract class VirtualContainerBase<C extends Control, B extends BehaviorBase<C>, I extends PageView> extends BehaviorSkinBase<C, B> {

    protected boolean pageCountDirty;
     ...
     * all the cells.
     */
    protected final VirtualPageFlow<I> flow;
     ...
     */
    protected VirtualPageFlow<I> createVirtualFlow() {
