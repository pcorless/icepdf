...
/**
 * Still not sure how this will look, but needs a nice diff tool for comparing extracted text.
 */
public class TextComparePane extends ComparatorPane {

    public TextComparePane(Mediator mediator) {
        super(mediator);
    }
